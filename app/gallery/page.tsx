...
const productImages = [
  {
    src: "/images/varad/broach-hero.jpg",
    title: "Broach Manufacturing",
    alt: "Precision broaches manufactured by Varad Engineering",
    link: "/products",
  },
  {
    src: "/images/varad/broaches.jpg",
    title: "Keyway & Flat Broaches",
    alt: "Precision flat and keyway broaches manufactured by Varad Engineering",
...
const workshopImages = [
  {
    src: "/images/varad/cnc.jpg",
    title: "CNC Machining Setup",
    alt: "Varad Engineering manufacturing workshop in Chakan, Pune",
    link: "/manufacturing",
  },
  {
    src: "/images/varad/cylindrical-grinding.jpg",
    title: "Grinding Facility",
    alt: "Grinding facility at Varad Engineering workshop in Chakan, Pune",
    link: "/manufacturing",
  },
];
        ...
        <div className="container-shell section-shell">
          ...
          <section className="mt-8 sm:mt-14">
            <div className="flex items-end justify-between border-b border-slate-200 pb-3 sm:pb-4">
              ...
              <Link href="/products" className="text-xs font-bold text-[#0b4267] hover:underline">
            ...
            <div className="mt-4 grid gap-3 sm:mt-6 sm:gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {productImages.map((image) => (
                <Link
                  key={image.src}
                  href={image.link}
                  className="group overflow-hidden border border-slate-200 bg-white hover:border-[#0a3858] transition-colors"
                >
                  <figure>
                    ...
                    <figcaption className="p-3 text-sm font-bold text-slate-900 sm:p-4 sm:text-base flex items-center justify-between">
                      ...
                      <ArrowRight className="h-4 w-4 text-[#0b4267] opacity-0 group-hover:opacity-100 transition-opacity" />
                    </figcaption>
                  </figure>
                </Link>
              ))}
          ...
          <section className="mt-8 sm:mt-16">
            <div className="flex items-end justify-between border-b border-slate-200 pb-3 sm:pb-4">
              ...
              <Link href="/manufacturing" className="text-xs font-bold text-[#0b4267] hover:underline">
                View Machinery Specs &rarr;
              </Link>
            </div>
          ...
          <section className="mt-8 sm:mt-16">
            <div className="flex items-end justify-between border-b border-slate-200 pb-3 sm:pb-4">
              ...
              <Link href="/quality" className="text-xs font-bold text-[#0b4267] hover:underline">
                View Inspection Facilities &rarr;
              </Link>
            </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-200 pt-6 sm:mt-16 sm:pt-8">
            <Link
              href="/contact"
              className="inline-flex min-h-11 items-center gap-2 bg-[#0b4267] px-5 text-sm font-bold text-white hover:bg-[#083653] sm:min-h-12 sm:px-6 sm:text-base transition-colors"
            >
